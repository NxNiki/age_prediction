data <-read.csv(file = "behav_summary_ptsd.csv")
...
hist(data$pcpt_t_tp,breaks=20) # has a few outliers
...
fit2 <-lm(residual ~  plot_tc  + padt_a + mp_mp2rtcr  , data=data)
summary(fit2)

plot(data$age, data$residual, main="Scatterplot Example", 
     xlab="age", ylab = "residuals ", pch=19)
